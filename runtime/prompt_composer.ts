...
const EMISSION_GRAMMARS_TEXT = [
  ...
  "        diff:      \"<replacement text — what the file looks like after edit>\"",
  "      },",
  "      evidence_event_ids: [\"<source_event_id>\", ...]",
  "    }",
  "    The structured proposed_behavior is what unlocks lesson_implementer_queue_view.",
  "    auto_apply_eligible=1; the gate REFUSES unstructured prose for cli/* + runtime/*",
  "    targets (owner-consent targets like CLAUDE.md require explicit approval regardless).",
