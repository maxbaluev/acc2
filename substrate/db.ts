...
const EVENT_HOT_PATH_INDEXES = [
  ...
  // 2026-05-22 covering-index audit: owner_autonomy autonomy loop's recent-by-origin
  // query (runtime/owner_autonomy.ts:857 — WHERE substrate_origin=? ORDER BY ts DESC
