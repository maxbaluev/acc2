...
const POLICY_BUNDLE_SEEDS: PolicyBundleSeed[] = [
  ...
  "",
  "  declared_sandbox (on every act_artifact_candidate):",
  "    {",
  ...
  "",
  "  act_artifact_candidate.payload (provenance — universal action handle: code, recipes, checklists, queries, browser flows, contacts, calendar events, sensor streams):",
  "    {",
...
const PREDICATE_SEEDS: PredicateSeed[] = [
  ...
  },
  {
    ...
    contract: "select owner-visible rendering by profile and task context, downstream of delegation_safety_predicate; ground in Adaptive Querying with AI Persona Priors (arXiv 2605.00696) and Personalized RewardBench (Ma et al. 2026).",
    ...
    closure_predicate: "rendering audits + owner feedback agree on chosen variant AND delegation_safety did not refuse upstream.",
