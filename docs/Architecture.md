...
Per brain dispatch `VJDMME8JD961SE6F` amendment `4AV2NPJW2H1HV0XQ3MR2ZV78KC` (KCs `R6BS0FP17S6375` + `ZM4HZPQFMS2D7E`), the substrate ships as a release while every installation is a living organism. Three normative boundaries close the distribution-readiness gap:
